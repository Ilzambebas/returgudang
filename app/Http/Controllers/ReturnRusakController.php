...
class ReturnRusakController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.pages.return.return-rusak.create',compact('barang','jenis','pic'));
    }
    ...
    function prosesPengecekanPost(Request $request) {
        ...
        if ($request->status == 'ya') {
            ...
            return redirect()->route('return-rusak.tindaklanjut', $request->get('id'));
        } else {
