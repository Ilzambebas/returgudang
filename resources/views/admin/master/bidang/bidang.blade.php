...
@section('content')
<!-- create modal -->
@include('admin.master.bidang.create')
<!-- create modal -->

<!-- edit modal -->
@include('admin.master.bidang.edit')
<!-- edit modal -->

<!-- hapus modal -->
@include('admin.master.bidang.delete')
<!-- hapus modal -->
                                ...
                                <tbody class="border-t">
                                    ...
                                    <tr>
                                        ...
                                        <div class="flex items-center justify-center">
                                                <button id="edit" data-modal-target="editModal" data-modal-toggle="editModal" class="bg-warning text-white py-2 px-4 rounded shadow-lg flex items-center mx-3 edit-data"  data-id="{{ $row->id_bidang }}">
                                                    <div class="font-sm">Edit</div>
                                                    <div class="content-center mx-1">
                                                        <img src="{{ asset('img/edit.svg') }}" alt="">
                                                    </div>
                                                </button>
                                                <button data-modal-target="hapusModal" data-modal-toggle="hapusModal" class="bg-danger text-white py-2 px-4 rounded shadow-lg flex items-center hapus-data" data-id="{{ $row->id_bidang }}">
...
<script>
    ...
    $('#SubmitUpdateForm').click(function(e) {
        ...
        $.ajax({
            url: `{{ route('bidang.update') }}`,
            method: 'POST',
            data: {
                id: $('#id').val(),
                nama_bidang: $('#nama_bidang').val(),
                status: $('#status_bidang').val(),
            },
