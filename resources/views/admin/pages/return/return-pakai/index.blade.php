...
<div id="hapusModal" tabrusak="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" style="z-index: 15;">
            ...
            <!-- Modal body -->
            <form method="POST" enctype="multipart/form-data" action="{{ route('return-layak-pakai.destroyData') }}">
                @csrf
                                ...
                                <tbody class="border-t">
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                    <a href="{{ route('return-layak-pakai.show',$item->id_detail_return) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                            ...
                                            <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                @if ($item->status_penerimaan == 'Y')
                                                    @if (Auth::user()->level == 'admin')
                                                        ...
                                                        @else
                                                            <span class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300"><a href="{{ route('return-layak-pakai.tindaklanjut',$item->id_detail_return) }}">Tindak Lanjut</a></span>
                                                        @endif
                                                    @else
                                                ...
                                                @else
                                                    @if (Auth::user()->level == 'admin')
                                                        <span class="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300"><a href="{{ route('return-layak-pakai.prosesPengecekan',$item->id_detail_return) }}">Proses Pengecekan</a></span>
                                                    @else
