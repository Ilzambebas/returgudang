            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl dark:bg-gray-950 border-black-125 rounded-2xl bg-clip-border" >
                <div class="p-4">
                    ...
                    <div>
                        ...
                        <form action="{{ route('return-rusak.update',$data->id_detail_return) }}" method="POST">
                        @csrf
                        @method('put')
                            ...
                            <div class="flex flex-wrap -mx-2">
                                ...
                                <div class="w-full p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                    <div class="flex justify-end">
                                        <a href="{{ route('return-rusak.index') }}" type="reset" class="bg-danger text-white py-2 px-4 rounded shadow-lg flex items-start mx-3">Kembali</a>
