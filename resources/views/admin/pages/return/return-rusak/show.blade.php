                        ...
                        <div class="p-0 overflow-x-scroll overflow-x-auto mt-4">
                            <div class="flex flex-wrap -mx-2">
                                ...
                                <div class="w-full md:w-1/2 px-2 mb-4">
                                    ...
                                    <select readonly disabled name="bidang_id"  id="jenis_id" required class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 jenis_id" >
                                ...
                                <div class="w-full md:w-1/2 px-2 mb-4">
                                    ...
                                    <select disabled readonly name="jenis_id"  id="jenis_id" required class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 jenis_id" >
                                ...
                                <div class="w-full md:w-full px-2 mb-4">
                                    ...
                                    <textarea readonly disabled name="deskripsi" id="" cols="30" rows="10" placeholder="Ketik disini" class="placeholder:text-gray-500 text-sm
